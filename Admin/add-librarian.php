                          ...
                          <form action="" method="POST" enctype="multipart/form-data">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                      <strong>Success!</strong> Librarian Added Successfully!
...
<!-- alert end -->
                                <h3 class="register-heading"> Register Librarian </h3>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                          <label><sup style="color: red;"></sup></label>
                                            <input type="submit" class="btn btn-compose" value="Register Librarian" name="save" />
                                        </div>
