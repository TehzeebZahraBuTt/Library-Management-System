...
if(isset($_POST['save'])){
    ...
    extract($_POST);
    $sql="insert into book_categories(cat_name) values('$name')";
...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Admin | Add Book Category</title>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                          <label><sup style="color: red;"></sup></label>
                                            <input type="submit" class="btn btn-compose" value="Add New Category" name="save" />
                                        </div>
